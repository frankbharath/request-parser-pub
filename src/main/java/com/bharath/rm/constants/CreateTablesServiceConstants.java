...
public class CreateTablesServiceConstants {
	...
	/** The Constant REFERENCECOLUMN. */
	public static final String REFERENCECOLUMN="reference-column";
	
	/** The Constant DELETECASCADE. */
	public static final String DELETECASCADE="delete-cascade";
